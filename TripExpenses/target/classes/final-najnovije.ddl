...
CREATE TABLE users (
    ...
    enabled                   NUMBER,
    authorities_authorityid   INTEGER NOT NULL,
    employees_employeeid      INTEGER NOT NULL,
...
ALTER TABLE authorities
    ADD CONSTRAINT authorities_users_fk FOREIGN KEY ( users_userid )
...
ALTER TABLE users
    ADD CONSTRAINT users_authorities_fk FOREIGN KEY ( authorities_authorityid )
